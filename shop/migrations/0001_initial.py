# Generated by Django 4.1.5 on 2023-01-22 03:31
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('template', models.CharField(choices=[('nour', 'nour'), ('food', 'food')], max_length=30)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(default='shop.webp', upload_to='shops/%y/%m/%d')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='shop.product')),
            ],
        ),
        migrations.CreateModel(
            name='CategoriesShop',
            fields=[
                ...
                ('slug', models.SlugField(blank=True, null=True)),
                ('father', models.ForeignKey(blank=True, limit_choices_to={'is_father': True}, null=True, on_delete=django.db.models.deletion.CASCADE, to='shop.categoriesshop')),
                ('shop', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='shop.shop')),
            ],
        ),
    ]
